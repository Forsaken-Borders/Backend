...
namespace ForsakenBorders.Backend.Migrations
{
    ...
    [Migration("20210914055621_RaisedUsernameFirstNameLastNameLimits")]
    partial class RaisedUsernameFirstNameLastNameLimits
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForsakenBorders.Backend.Utilities.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForsakenBorders.Backend.Utilities.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForsakenBorders.Backend.Utilities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForsakenBorders.Backend.Utilities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForsakenBorders.Backend.Utilities.Note", b =>
                {
                    b.HasOne("ForsakenBorders.Backend.Utilities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("ForsakenBorders.Backend.Utilities.Role", b =>
                {
                    b.HasOne("ForsakenBorders.Backend.Utilities.User", null)
                        .WithMany("Roles")
